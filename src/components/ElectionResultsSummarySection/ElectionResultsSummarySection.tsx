      ...
      {results == null &&
        ...
        (loader ? (
          ...
          <DivBodyHuge className={classes.warning}>
            Nu există date disponibile pentru această unitate administrativ teritorială. Fie nu există date disponibile, fie câștigătorii pentru această unitate au fost aleși în primul tur de scrutin.
          </DivBodyHuge>
        ))}
